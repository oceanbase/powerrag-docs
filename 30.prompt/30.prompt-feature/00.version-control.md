...
2. 单击目标提示词，进入提示词详情页面。
3. 在左侧版本列表单击版本后的![](https://intranetproxy.alipay.com/skylark/lark/0/2025/png/270449/1760522726076-b6afc072-e1a6-4acb-b1a7-1510911befdb.png)图标，在弹窗中选择 **生产 **标签或自定义标签，或增加自定义标签。
4. 单击 **保存**。
...
# 获取最新提示词版本。latest 标签由 AgentOps 自动维护
...
## 回滚
当提示词带有`production`标签时，SDK 中将默认提供该版本。您可以通过`production`在 AgentOps 界面中将标签设置为之前的版本来快速回滚到之前的版本。
...
4. 鼠标移动到要对比的修改前的版本，版本右下角将出现![](https://intranetproxy.alipay.com/skylark/lark/0/2025/png/270449/1760580944468-22a7db96-caab-4ab7-a766-b4cb8b4d31bc.png)图标。单击该图标，将出现弹窗，弹窗中展示两个版本的差异。
