...
数据集是输入和预期输出的集合，用于测试您的应用。基于控制台和 SDK 的跑测均支持 AgentOps 数据集。

AgentOps 数据集视图：

![](https://intranetproxy.alipay.com/skylark/lark/0/2025/png/270449/1760680747965-35dda4b2-47ce-4a91-97d3-3f53489261db.png)
...
要存档或删除该项目，请点击该项目旁边的![](https://intranetproxy.alipay.com/skylark/lark/0/2025/png/270449/1760682757751-160facba-1b13-425c-b0be-a004a9691ab4.png)图标，然后选择 **归档** 或 **删除**。

## 数据集跑测
创建数据集后，您可以基于数据集测试和评估您的应用。

+ [通过 SDK 跑测](/40.evaluation/20.run/20.run-via-sdk.md)
+ [通过控制台跑测](/40.evaluation/20.run/30.run-via-ui.md)
